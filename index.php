...
<head>
  ...
  <meta name="description" content="Join-me card cropper">
  <meta name="keywords" content="CELSZC RELATIVITY AVATAR">
  <meta name="author" content="Chen Fengyuan">
  <title>CELSZC RELATIVITY AVATAR</title>
...
<main class="pb-0">
    <div class="container">
    <img src="img/banner.jpg"  width="700px" class="img-thumbnail" alt="LCELSZC RELATIVITY AVATAR">
        <br>
        <div class="row">
            
            <h5 align="center">Create Your Avatar</h5>
        </div>
    </div>
  <!-- Content -->
  <div class="container">
    <div class="row">
      <div class="col-md-9" >
        <!-- <h3>Demo:</h3> -->
        <div class="img-container" style="background-image:url(img/templ.png)">
          <img id="image" src="dist/images/avatar.png" alt="Picture">
        </div>
      </div>
      <div class="col-md-3">
        <!-- <h3>Preview:</h3> -->
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a id="download" href="javascript:void(0);" download="cropped.jpg" ></a>
                  <button class="btn btn-success" type="submit" name="save" value="crop" id="crop" data-dismiss="modal">Download</button>
              </div>
            </div>
          </div>
        </div><!-- /.modal -->
